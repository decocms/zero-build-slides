...
description: Create, edit, and manage zero-build presentation decks using Preact + htm + Tailwind CDN. Use when the user wants to create a new presentation, add/edit slides, change themes, or understand the slide template system.
---
